                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-12 col-md-12 col-sm-12">
                                                <div class="utf-submit-field">
                                                    <select name="ville" class="utf-with-border">
                                            ...
                                            <div class="col-xl-12 col-md-12 col-sm-12">
                                                <div class="utf-submit-field">
                                                    <input type="text" name="libelle" class="utf-with-border" placeholder="Commune">
                                                </div>
                                            </div>
                            ...
                            <div class="dashboard-box">
                                <div class="headline filtre-input-content">
                                    ...
                                    <div class="sort-by filtre-input">
                                        <div class="utf-submit-field ">
                                            <input type="text" class="utf-with-border" placeholder="Commune">
                                        </div>
                                    </div>
                                </div>
                                <div class="content">
                                       ...
                                       @foreach($communes as $commune)
                                           <!-- Page Content -->
                                               <div class="w3-container">
                                                   <div id="id{{ $commune->id }}" class="w3-modal">
                                                       <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px">
                                                           <div class="w3-center"><br>
                                                               <span onclick="document.getElementById('id{{ $commune->id }}').style.display='none'" class="w3-button w3-xlarge w3-hover-red w3-display-topright" title="Close Modal">&times;</span>
                                                               <h3>Modification de mon eperience</h3>
                                                           </div>
                                                           <form class="w3-container" method="POST" action="{{ route('commune.update',['id'=> $commune->id]) }}">
                                                               @csrf
                                                                   ...
                                                                   <div class="row">
                                                                       <div class="col-xl-12 col-md-12 col-sm-12">
                                                                           <div class="utf-submit-field">
                                                                               <select name="ville" class="utf-with-border">
                                                                                   <option value="0">choisir une ville</option>
                                                                                   @foreach($villes as $ville)
                                                                                       <option value="{{ $ville->id }}" {{ $commune->ville_id ==  $ville->id ? "selected":""}}>{{ $ville->libelle }}</option>
                                                                                   @endforeach
                                                                               </select>
                                                                           </div>
                                                                       </div>
                                                                       <div class="col-xl-12 col-md-12 col-sm-12">
                                                                           <div class="utf-submit-field">
                                                                               ...
                                                                               @endif
                                                                               <input type="text" class="utf-with-border" placeholder="libelle" name="libelle" value="{{ old('lib')?? $commune->libelle }}">
                                                                           </div>
                                                                       </div>
                                                           ...
                                                           <div class="w3-container w3-border-top w3-padding-16 w3-light-grey">
                                                               <button onclick="document.getElementById('id{{$commune->id}}').style.display='none'" type="button" class="w3-button w3-red">Cancel</button>
                                                           </div>
                                                       </div>
                                                   </div>
                                               </div>
                                        <li>
                                            <div class="utf-invoice-list-item ">
                                                <ul>
                                                    <li>Id: <span> {{ $commune->id }}</span></li>
                                                    <li>Ville: <span> {{ $commune->ville->libelle??"" }}</span> </li>
                                                    <li>Commune: <span> {{ $commune->libelle }}</span> </li>
                                                    <li class="edit-trush-icone">
                                                        <a onclick="document.getElementById('id{{ $commune->id }}').style.display='block'" href="#"><span class="fa fa-pencil paid_"></span></a>
                                                        <a onclick="confirm('Voulez vous supprimer cette commune ?')" href="{{ route('commune.delete',['id' => $commune->id]) }}"><span class="fa fa-trash paid_"></span></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
